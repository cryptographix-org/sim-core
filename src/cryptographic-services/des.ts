...
class DESSecretKey implements CryptoKey {
  private _keyMaterial: ByteArray;
  private _extractable: boolean;
  private _algorithm: KeyAlgorithm;
  private _type: string;
  private _usages: string[];

  constructor( keyMaterial: ByteArray, algorithm: KeyAlgorithm, extractable: boolean, usages: string[] ) {
  ...
  get extractable(): boolean { return this._extractable; }
  get type() { return this._type; }
  get usages(): string[] { return Array.from( this._usages ); }
