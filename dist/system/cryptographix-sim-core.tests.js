System.register(['cryptographix-sim-core'], function (_export) {
    ...
    var ComponentBuilder, Direction, Container, inject, Graph, Node, Port, Network, ComponentFactory, RunState, ByteArray, Kind, KindBuilder, FieldTypes, Channel, EndPoint, Message, DummyComponent, DummyConfig, __decorate, __metadata, C1, C2, jsonGraph1, Oranges, FruityKind, IntegerMessage, __decorate, __metadata, gr1, C, __decorate, __metadata, StateLogger;
