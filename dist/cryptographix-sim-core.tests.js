  import { Container, inject, Graph, Node, Port, Direction, Network, ComponentFactory, RunState, ByteArray, Kind, KindBuilder, FieldTypes, ComponentBuilder, Channel, EndPoint, Message } from 'cryptographix-sim-core';
