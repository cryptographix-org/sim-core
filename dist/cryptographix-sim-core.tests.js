  import { Container, inject, ComponentBuilder, Direction, ByteArray, Kind, KindBuilder, FieldTypes, Graph, Node, Port, Network, ComponentFactory, RunState, Channel, EndPoint, Message } from 'cryptographix-sim-core';
