  import { ComponentBuilder, Direction, ByteArray, Kind, KindBuilder, FieldTypes, Graph, Node, Port, Network, ComponentFactory, RunState, Container, inject, Channel, EndPoint, Message } from 'cryptographix-sim-core';
